...
async function main() {
  ...
  console.log("Setting up RACE Protocol...");
  console.log("Account:", deployer.address);

  const RWA_VAULT_ADDRESS = "0x0E62b507DeD8E3918e43838b5EF8e77B437f7927";
  const AI_AGENT_ADDRESS = "0x80E4f1b1D7C7c50DBC3EC480f3F18f25683D6066";
  ...
  console.log("\n✅ Setup complete! AI Agent is ready to borrow and invest.");
}
